...
void loop() {
  ...
  if(Choose_light=="1"){pwmLed(LED_num.toInt(),Light_num.toInt());}//pwmLed(幾顆LED上限10,亮度上限1000)
  else{breathing(LED_num.toInt(),Breathe_speed.toInt());}//breathing(幾顆LED上限10,延遲多久上限15)}
